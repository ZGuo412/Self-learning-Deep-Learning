...
##Prepare the Resnet generator model
...
##Load the gold retriever image and put it into the net model

img = Image.open("bobby.jpg")

##Resize the image and transfer it to tenser
